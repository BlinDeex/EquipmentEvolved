...
public class PrefixLethal : BaseEvolvedPrefix
{
    ...
    public override void ApplyAccessoryEffects(Player player)
    {
        ...
        statPlayer.AddStat(ModContent.GetInstance<CritDamageStat>(), PrefixBalance.LETHAL_CRIT_DMG_MUL, StatSource.Accessory);
    }
}