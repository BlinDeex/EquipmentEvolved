...
public class PrefixRevitalizing : BaseEvolvedPrefix
{
    ...
    public override void ApplyAccessoryEffects(Player player)
    {
        ...
        statPlayer.AddStat(ModContent.GetInstance<RegenStat>(), PrefixBalance.REVITALIZING_REGENERATION, StatSource.Accessory);
    }
}