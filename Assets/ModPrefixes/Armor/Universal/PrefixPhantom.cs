...
using EquipmentEvolved.Assets.ModPlayers.Armor.Universal.Phantom;
using Terraria;
...
public class PrefixPhantom : ModPrefix, ISpecializedPrefix
{
    ...
    public override LocalizedText DisplayName => LocalizationManager.GetPrefixLocalization(this,"Phantom", "DisplayName");


    public override void SetStaticDefaults()
    {
        SetBonus = LocalizationManager.GetPrefixLocalization(this,"Phantom", nameof(SetBonus));
        Desc = LocalizationManager.GetPrefixLocalization(this,"Phantom", nameof(Desc));
    }
