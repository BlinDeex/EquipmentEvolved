...
namespace EquipmentEvolved.Assets.ModPrefixes.Armor.Universal
{
    public class PrefixAugmented : ModPrefix, ISpecializedPrefix
    {
        ...
        public override LocalizedText DisplayName => LocalizationManager.GetPrefixLocalization(this, "Augmented", "DisplayName");
        ...
        public override IEnumerable<TooltipLine> GetTooltipLines(Item item)
        {
            ...
            TooltipLine desc = new TooltipLine(Mod, "desc", Desc.Value)
            {
                IsModifier = true,
            ...
            TooltipLine setBonus = new TooltipLine(Mod, "setBonus", SetBonus.Format(Math.Round(PrefixBalance.AUGMENTED_SET_BONUS_DAMAGE_PER_BUFF * 100, 2)) + buffBonus)
            {
                IsModifier = true,
        ...
        // Cant do logic here cuz idk which armor piece is running rn
