...
public class CursedArmorPlayer : ModPlayer
{
    ...
    public override void ModifyHitByNPC(NPC npc, ref Player.HurtModifiers modifiers)
    {
        ...
        modifiers.ModifyHurtInfo += (ref Player.HurtInfo info) => { ModifyDamageForCursed(ref info); };
    }
    ...
    private void ModifyDamageForCursed(ref Player.HurtInfo info)
    {
        ...
        float damageTakenPercent = cursedAugmentation ? PrefixBalance.AUGMENTATION_CURSED_DAMAGE_TAKEN_PERCENT : PrefixBalance.CURSED_DAMAGE_TAKEN_PERCENT;
