...
public class ArmorAbilityPlayer : ModPlayer
{
    ...
    /// <param name="passive">True if set bonus ability is running every tick (for example augmented set bonus) with no cooldown but needs to follow armor set bonus rules</param>
    ...
    {
        bool activateArmor = EquipmentEvolvedSystem.ArmorActivationKeybind.JustPressed;
