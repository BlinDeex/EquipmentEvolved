...
using EquipmentEvolved.Assets.Globals.NPCs;
...
namespace EquipmentEvolved.Assets.NPCs;
...
public class ChallengerOrb : ModNPC
{
    ...
    public override void OnSpawn(IEntitySource source)
    {
        ...
        float currentScore = owner.GetModPlayer<ChallengerPlayer>().ChallengerScore;
    ...
    private void Effects()
    {
        ...
        for (int i = 0; i < guaranteedSpawns; i++) SpawnDust(radius);
    ...
    private void SpawnDust(float radius)
    {
        ...
        int dustID = Dust.NewDust(pos, 1, 1, ModContent.DustType<ChallengerDust>(),
    ...
    private void HitDust()
    {
        ...
        for (int i = 0; i < nodeCount; i++)
        {
            ...
            for (int j = 0; j < dustCount; j++)
            {
                ...
                int dustID = Dust.NewDust(NPC.Center, 1, 1, ModContent.DustType<ChallengerDust>(),
                    newColor: GetOrbDustColor((ChallengerOrbType)(int)OrbType));
    ...
    private void MoveOrb(Vector2 ownerPos)
    {
        ...
        Vector2 wiggleVelocity = new Vector2(wiggleX, wiggleY);
